  ...
  <div>
    ...
    <div className="flex items-end justify-center mt-4 box-border border-2 h-50 w-50 p-4 rounded-md border-solid border-white">
      ...
      <div className="absolute mb-12">
        ...
        <ul>
          <li className="text-slate-100 font-Manrope shadow-md shadow-black ">Experience Pts:</li>
          <li className="text-slate-100 font-Manrope shadow-md shadow-black">Level:</li>
          <li className="text-slate-100 font-Manrope shadow-md shadow-black">Goals Completed:</li>
        </ul>
